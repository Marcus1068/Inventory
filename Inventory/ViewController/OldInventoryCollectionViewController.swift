...
class OldInventoryCollectionViewController: UICollectionViewController, UISearchControllerDelegate, UISearchBarDelegate, UISearchResultsUpdating {
 ...
 /*       filteredInventory = inventory.filter({( inv : Inventory) -> Bool in
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        case UICollectionView.elementKindSectionHeader:
            let headerView = collection.dequeueReusableSupplementaryView(ofKind: kind,
                                                                         ...
                                                                         for: indexPath) as! OldInventoryHeaderCollectionReusableView
        ...
        case UICollectionView.elementKindSectionFooter:
            let footerView = collection.dequeueReusableSupplementaryView(ofKind: kind,
                                                                         ...
                                                                         for: indexPath) as! OldInventoryFooterCollectionReusableView
  ...
  /*          if isFiltering(){
    ...
    @IBAction func organizeButton(_ sender: Any) {
        ...
        self.navigationItem.setLeftBarButton(UIBarButtonItem(barButtonSystemItem: .cancel, target: self, action: #selector(OldInventoryCollectionViewController.cancelDelete)), animated: true)
        
        // right nav bar button to done
        self.navigationItem.setRightBarButton(UIBarButtonItem(barButtonSystemItem: .done, target: self, action: #selector(OldInventoryCollectionViewController.doneDelete)), animated: true)
...
extension OldInventoryCollectionViewController: NSFetchedResultsControllerDelegate {
