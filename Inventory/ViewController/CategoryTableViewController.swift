...
class CategoryTableViewController: UITableViewController, UIPointerInteractionDelegate {
    ...
    override var keyCommands: [UIKeyCommand]? {
        return [
            ...
            UIKeyCommand(title: "", image: nil, action: #selector(addButton), input: "A", modifierFlags: .command, propertyList: nil, alternates: [], discoverabilityTitle: Global.addcategory, state: .on)
        ]
    }
    ...
    */
    ...
    @IBAction func addButton(_ sender: Any) {
        performSegue(withIdentifier: "addSegueCategory", sender: nil)
    }
}
