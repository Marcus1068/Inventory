...
class ReportViewController: UIViewController {
    ...
    func pdfCreateInventoryReport(){
        ...
        let footerText = NSLocalizedString("generated by Inventory (c) 2019 Marcus Deuß", comment: "generated by Inventory (c) 2019 Marcus Deuß")
        ...
        let pdf = renderer.pdfData { (context) in
            ...
            for inv in results{
                ...
                // current layout fits 49 rows in one page
                if numberOfRows > 48{
                    numberOfRows = 1
                    y = contents_begin
        ...
        do {
            ...
            os_log("ReportViewController pdfCreateInventoryReport successfull", log: Log.viewcontroller, type: .info)
        } catch {
            os_log("ReportViewController pdfCreateInventoryReport error", log: Log.viewcontroller, type: .error)
        }
    }
