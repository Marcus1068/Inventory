...
class OwnerTableViewController: UITableViewController, UIPointerInteractionDelegate {
    ...
    override var keyCommands: [UIKeyCommand]? {
        return [
            ...
            UIKeyCommand(title: "", image: nil, action: #selector(addButton), input: "A", modifierFlags: .command, propertyList: nil, alternates: [], discoverabilityTitle: Global.addOwner, state: .on)
        ]
    }
